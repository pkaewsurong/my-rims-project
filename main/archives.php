...
<div class="page-header">
    <div>
        <h1 class="page-title"><i class="ri-archive-line me-2"></i>คลังข้อมูลวิจัย</h1>
    ...
    <button class="btn btn-dark fw-bold" onclick="openUploadModal()">
        <i class="ri-upload-2-line me-1"></i> อัปโหลดชุดข้อมูล
    </button>
</div>
