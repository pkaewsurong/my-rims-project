    ...
    <div class="card p-6 relative overflow-hidden">
        <div class="mb-6 flex justify-between items-start">
            ...
            <div class="flex flex-col items-end space-y-2">
                ...
                <?php if (!$isReadonly): ?>
                <a href="/public/ip-assets/create?project_id=<?= e($project['id']) ?>" class="px-3 py-1.5 bg-indigo-50 text-indigo-600 border border-indigo-150 text-xs font-semibold rounded-lg hover:bg-indigo-100 transition-colors flex items-center">
